...
public:
  ...
  ~Vector()
  {
    ...
    __INC_INDENT
      ...
      __DEBUG_VECTOR_OUT__ << __INDENT_W_OFFSET( 2 ) << std::endl;
      __DEBUG_VECTOR_OUT__ << __INDENT_W_OFFSET( 2 ) << "*******************" << std::endl;
      __DEBUG_VECTOR_OUT__ << __INDENT_W_OFFSET( 2 ) << "Values: " << ( values ? static_cast<void*>(values): "null" ) << std::endl;
      __DEBUG_VECTOR_OUT__ << __INDENT_W_OFFSET( 2 ) << "*******************" << std::endl;
      __DEBUG_VECTOR_OUT__ << __INDENT_W_OFFSET( 2 ) << std::endl;
...
inline Vector<T>::Vector()
{
  ...
  values = nullptr;
    ...
    __DEBUG_VECTOR_OUT__ << __INDENT << "[->][++constructor++][" << instance_id << "] Vector<T>::Vector() //**  **" << std::endl << std::endl;
