...
//https://github.com/JeremyDsilva/String/blob/master/String.h

namespace NSTD {

  #define __DEBUG_STRING__     true
  #define __DEBUG_STRING_OUT__ std::cout
  ...
  // std::ostream& operator<< (std::ostream& os, const NSTD::String& str);

  // std::istream& operator>> (std::istream& is, NSTD::String& str);

  // std::istream& getline(std::istream& is, NSTD::String& str, char delim);

  // std::istream& getline(std::istream& is, NSTD::String& str);

  //using size_type = size_t;

  #define __SAFE_DELETE__( ptr ) { if ( ptr ) delete[] ptr; ptr = nullptr; }
  ...
  */
  ...
  inline void String::_append( const char * other )
  {
    ...
    return _append( other, other ? strlen(other): 0 );
  ...
  void String::_append( const char * other, size_t n )
  {
    ...
    if ( !other || n == 0 )
    { // if other is null or size is 0 do nothing
  ...
  void String::_insert_str( size_type pos, const char * other, size_t n )
  {
    ...
    if ( pos == _str_len )
    { // if pos is _str_len then append
    ...
    if ( pos > _str_len )
    {  // if pos is bigger than size then throw
      throw;

    }

    if ( n == 0 )
    {	// if other is null or empty then do nothing
    ...
    if ( _str )
    {
      ...
      __SAFE_DELETE__( buffer ); // freeMemory used
  ...
  void String::_replace( size_type pos, size_t len, const char * other, size_t n )
  {
    ...
    // free memory
    __SAFE_DELETE__( replace_buffer );
    __SAFE_DELETE__( buffer );
  ...
  */
  ...
  size_t String::find( const String& other, size_type pos ) const
  { //string(1)
  ...
  size_t String::find( const char* s, size_type pos ) const
  { // c - string(2)
  ...
  size_t String::find( const char* s, size_type pos, size_type n ) const
  { // buffer(3)
  ...
  size_t String::rfind( const String& other, size_type pos ) const
  { // string(1)
  ...
  size_t String::rfind( const char* s, size_type pos ) const
  { // c - string(2)
  ...
  size_t String::rfind( const char* s, size_type pos, size_t n ) const
  { // buffer(3)
  ...
  // find_first_of
  size_t String::find_first_of( const String& other, size_type pos ) const
  { // string(1)
  ...
  size_t String::find_first_of( const char* other, size_type pos ) const
  { // c - string(2)
  ...
  size_t String::find_first_of( const char* other, size_type pos, size_t n ) const
  { // buffer(3)
  ...
  size_t String::find_first_of( char c, size_type pos ) const
  { // character(4)
  ...
  size_t String::find_last_of( const String& other, size_type pos ) const
  { // string(1)
  ...
  size_t String::find_last_of( const char* other, size_type pos ) const
  { // c - string(2)
  ...
  size_t String::find_last_of( const char* other, size_type pos, size_t n ) const
  { // buffer(3)
  ...
  size_t String::find_last_of( char c, size_type pos ) const
  { // character(4)
  ...
  size_t String::find_first_not_of( const String& other, size_type pos ) const
  { // string(1)
  ...
  size_t String::find_first_not_of( const char* other, size_type pos ) const
  { // c - string(2)
  ...
  size_t String::find_first_not_of( const char* other, size_type pos, size_t n ) const
  { // buffer(3)
  ...
  size_t String::find_last_not_of( const String& other, size_type pos ) const
  { // string(1)
  ...
  size_t String::find_last_not_of( const char* other, size_type pos, size_t n ) const
  { // buffer(3)
  ...
  size_t String::find_last_not_of( char c, size_type pos ) const
  { // character(4)
  ...
  */
  ...
  void String::const_reverse_iterator::_add( const_reverse_iterator & toReturn, size_type i )
  {
    ...
    { // at the end and i not equal to 0
